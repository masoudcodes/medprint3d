...
DATABASES = {
    'default': {
        ...
        'NAME': env('DB_NAME', default='medical3dprint'),
...
# Trust Cloudflare's X-Forwarded-Proto so DRF returns https:// URLs for file fields
...
# 3D Slicer — path to the Slicer executable on the admin's local machine
# Windows : C:/Program Files/Slicer 5.6.2/Slicer.exe
# macOS   : /Applications/Slicer.app/Contents/MacOS/Slicer
# Linux   : /opt/slicer/Slicer
SLICER_PATH = env('SLICER_PATH', default='Slicer')
